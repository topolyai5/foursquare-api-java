...
public class FoursquareApi {
     ...
     */
    public Result<Recommended> venuesExplore(String ll, Double llAcc, Double alt, Double altAcc, Integer radius, String section, String query, Integer limit, String basis, String venuePhotos) throws FoursquareApiException {
        try {
            ...
            return getRecommendedResult(response);
        } catch (JSONException e) {
            throw new FoursquareApiException(e);
        }
    }

    private Result<Recommended> getRecommendedResult(ApiRequestResponse response) throws FoursquareApiException, JSONException {
    ...
    public Result<Recommended> venuesExplore(Map<String, String> params) throws FoursquareApiException {
        ...
        try {
            ApiRequestResponse response = doApiRequest(Method.GET, "venues/explore", isAuthenticated(), args);
            return getRecommendedResult(response);
        } catch (JSONException e) {
            throw new FoursquareApiException(e);
        }
